...
const TEAM_MEMBERS = [
  {
    ...
    bio: "Ayantha Senanayaka is an Assistant Professor in the Department of Manufacturing and Engineering Technology at Tennessee Technological University. His research focuses on smart manufacturing, predictive maintenance, robotics, and non-contact sensing systems. He specializes in integrating machine learning with advanced sensing technologies for improving manufacturing system reliability and efficiency. His work emphasizes scalable, cost-effective solutions for industrial applications, particularly in high-speed robotic environments. He has published in leading journals and conferences in manufacturing and industrial engineering and actively contributes to interdisciplinary research in intelligent manufacturing systems.",
  ...
  },
  {
    ...
    bio: "Md Omar Al Javed is a Graduate Research Assistant in the Department of Mechanical and Nuclear Engineering at Tennessee Technological University, Cookeville, Tennessee, USA. His research focuses on smart manufacturing, predictive maintenance, industrial robotics, and data-driven decision-making. He received his BS in Industrial and Production Engineering from the Military Institute of Science and Technology (MIST), Bangladesh. His background includes manufacturing process optimization, design of experiments, and machining process analysis. He has authored and co-authored several journal and conference publications in manufacturing and industrial engineering.",
